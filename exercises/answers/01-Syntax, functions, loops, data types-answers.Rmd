...
Try to run the following code in the console. What is the problem with it, can you fix the code? ***Missing multiplication `*` sign***
...
Please explain what each of the following operators: `& | ! !=`, you can use the following (and modify it in any way):
...
How many flower-types are there in `iris`? **Three: setosa, versicolor, virginica**
How many cylinder values are there in `mtcars`? **Also three: 4, 6, 8**
...
WARNING:
This is a **relatively complex** exercise if you're not fluent in programming, and it's not directly related to data analysis. The reasone I am giving you this exercise is that it is a great exercise to reherse elements we were discussing, in one single exercise.
